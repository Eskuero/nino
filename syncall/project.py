	...
	def sign(self, workdir):
		...
		for apk in apks:
			...
			if verify == 1:
				...
				sign = subprocess.Popen(["apksigner", "sign", "--ks", self.signinfo["path"], "--ks-key-alias", self.keyalias,"--out", workdir + "/SYNCALL-RELEASES/" + displayname, "--in", apk], stdout = self.logfile, stdin=subprocess.PIPE, stderr=subprocess.STDOUT)
